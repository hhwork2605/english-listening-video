...
for (const turn of turns) {
  ...
  if (!pcm) {
    writeFileSync(dataPath, JSON.stringify(doc, null, 2), "utf8"); // lưu tiến độ trước khi dừng
  ...
  made++;
  writeFileSync(dataPath, JSON.stringify(doc, null, 2), "utf8"); // lưu sau mỗi lượt (an toàn resume)
