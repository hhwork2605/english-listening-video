...
6. **GIỮ "MOMENT" của reel** — writer cố ý cài một moment (hiểu lầm hài, sự cố
   nhỏ, twist lượt cuối, chi tiết bất ngờ…). Khi cắt gọn/hạ cấp độ, TUYỆT ĐỐI
   không cắt mất moment hay làm nó bớt rõ — đó là lý do người xem ở lại; chỉ
   đơn giản hoá cách diễn đạt, không xoá tình tiết. Reel sau khi sửa mà đọc
   lên "không có gì xảy ra" = sửa HỎNG.
